...
int divide(int a, int b) {
  ...
  return res * sign;
	...
	\par The implementation is based on \href{https://en.cppreference.com/w/cpp/algorithm/next_permutation}{possible implementation} of next\_permutation. To understand how \href{https://en.cppreference.com/w/cpp/iterator/reverse_iterator/base}{reverse\_iterator::base} works, see the following snippet:
	\begin{lstlisting}
int main()
{
  ...
  assert(*res == 2 && *base == 3);
	...
	\end{lstlisting}
	Knowing that, we have the following solution:
	\begin{lstlisting}
